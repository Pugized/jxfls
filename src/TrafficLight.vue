...
<template>
    <div v-if="isTauri() && !isMobile()" class="flex flex-row">
        <div class="h-3 w-3 rounded-[10px] bg-[#FF5F57] red-light mt-auto mb-auto ml-2 border-[0.5px] border-black/20 relative p-0" @mouseover="onHover('close')" @mouseout="onOut('close')">
        ...
        <div class="h-3 w-3 rounded-[10px] bg-[#FEBC2E] yellow-light mt-auto mb-auto ml-2 border-[0.5px] z-10 border-black/20 relative" @mouseover="onHover('minimize')" @mouseout="onOut('minimize')">
